...
export default function MovingLogos() {
  return (
    <div className="flex flex-col gap-6 py-10 px-8 w-full bg-(--color-secondary) border-y border-gray-300">
        <h2 className="uppercase text-sm text-center font-semibold tracking-wider text-(--color-muted-text)">Working with New Zealand's leading lenders</h2>
